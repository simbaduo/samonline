...
const MobileHeader = () => {
  return (   
    <>
    <Container> <div className="mobileHeader">
      <img height="80px" width="130px" src={samlogo}/>
      <div className="mobileReviewBox">
        <p>Beverly Hills Auto Repair</p>
        <span className="inlineContainer"><img className="starsAdjust" width="60px" height="15px" src={stars}/>
        <a href="/ReviewsPage" className="tiny">5 Star Rating Based On 123 Reviews</a></span>
